...
// hybrid: nextflow run assembly.nf --assemblyType hybrid --qcreads_illumina /path/to/illumina_reads --qcreads_ont /path/to/ont_reads --ref_genome /path/to/reference_genome
// illumina: nextflow run assembly.nf --assemblyType illumina --qcreads_illumina /path/to/illumina_reads --ref_genome /path/to/reference_genome
// ont: nextflow run assembly.nf --assemblyType ont --qcreads_ont /path/to/ont_reads --ref_genome /path/to/reference_genome